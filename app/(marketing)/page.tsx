            ...
            {featuredServices.map((s, i) => (
              <Reveal key={s.slug} delay={(i % 3) * 0.05}>
                <Link
                  ...
                  className="group block transition-transform duration-[550ms] ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-2"
                  data-cursor="Explore ↗"
                >
                  <div className="relative overflow-hidden rounded-xl border border-line bg-surface-2 transition-all duration-[550ms] ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:border-cobalt/60 group-hover:shadow-[0_28px_60px_-32px_color-mix(in_oklab,var(--color-cobalt)_55%,transparent)]">
                    ...
                    <span className="pointer-events-none absolute right-3 top-3 z-[3] inline-flex translate-y-1 items-center gap-1 rounded-full bg-white/15 px-2.5 py-1 text-[11px] font-medium text-white opacity-0 backdrop-blur-md transition-all duration-[550ms] ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:translate-y-0 group-hover:opacity-100">
                      View <ArrowRight className="h-3 w-3" aria-hidden="true" />
                    </span>
                  </div>
                  <h3 className="mt-5 flex items-center gap-2 text-xl transition-colors duration-300 group-hover:text-cobalt">
                    {s.title}
                    <ArrowRight className="h-4 w-4 -translate-x-1 opacity-0 transition-all duration-[550ms] ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:translate-x-0 group-hover:opacity-100" aria-hidden="true" />
                  </h3>
